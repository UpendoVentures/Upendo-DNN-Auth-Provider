...
This project is not meant to be used as-is.  Instead, it should be used as a starting point for your own authentication provider.  

You can also start by using the [UpendoDNN Generator](https://github.com/UpendoVentures/generator-upendodnn#readme).  This template was used to add the automated template in that DNN developer tool.  
